...
namespace NavValueCalculator
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = GetCSFANewAtc(DTP_FROM.Value.Date, DTP_TO.Value.Date, 0);
        ...
        public DataTable GetCSFANewAtc(DateTime fromdate, DateTime todate, int atcid = 0)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                row["FRatio"] = FRatio;
                row["ARatio"] = ARatio;
                row["Locked_CRatio"] = Decimal.Parse(Locked_CRatio.ToString()).ToString("F"); ;
                row["Locked_SRatio"] = Decimal.Parse(Locked_SRatio.ToString()).ToString("F"); ;
                row["Locked_FRatio"] = Decimal.Parse(Locked_FRatio.ToString()).ToString("F"); ;
                row["Locked_ARatio"] = Decimal.Parse(Locked_ARatio.ToString()).ToString("F"); ;
            ...
            foreach (DataRow row in distinctValues.Rows)
            {
                ...
                try
                {
                    ...
                    row["JCM"] = Decimal.Parse(JCM.ToString()).ToString("F");
                }
                catch (Exception)
                {
                ...
                try
                {
                    ...
                    row["CutJCMValue"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    row["CRatio"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    row["SewJCMValue"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    row["SRatio"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    row["AirportJCMValue"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    row["ARatio"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    row["FinishingJCMValue"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    ...
                    row["FRatio"] = Decimal.Parse(cutValqry.ToString()).ToString("F");
                }
                catch (Exception ex)
                {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            dATAeXPORTER.ExportToExcelWithFormat(dataGridView1);
        }
